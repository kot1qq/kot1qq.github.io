...
function copyAll(){
let a1 = document.getElementById("did1").innerHTML; let a2 = document.getElementById("did2").innerHTML; let a3 = document.getElementById("did3").innerHTML; let a4 = document.getElementById("did4").innerHTML; let a5 = document.getElementById("did5").innerHTML; let a6 = document.getElementById("did6").innerHTML; let a7 = document.getElementById("did7").innerHTML; let a8 = document.getElementById("did8").innerHTML; let a9 = document.getElementById("did9").innerHTML; let a10 = document.getElementById("did10").innerHTML; let dids = "1." + a1 +  " | 2." + a2 + " | 3."+ a3 + " | 4." + a4 + " | 5." + a5 + " | 6." + a6 + " | 7." + a7 + " | 8." + a8 + " | 9." +  a9 + " | 10." + a10 + " |";
navigator.clipboard.writeText(dids); alert("Скопировано");}
